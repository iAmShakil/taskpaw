<template>
  <div class="container mx-auto max-w-6xl terms-page">
    <p class="mt-20" /></p><p>
      Welcome to TaskPaw!
    </p>
    <p>
      These terms and conditions outline the rules and regulations for the use of
      TaskPaw's Website, located at https://taskpaw.com.
    </p>
    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use TaskPaw if you do not agree to take all of the terms
    ...
    <p>
      We employ the use of cookies. By accessing TaskPaw, you agreed to use
      cookies in agreement with the TaskPaw's Privacy Policy.
    </p>
    <p>
    ...
    <p>
      Unless otherwise stated, TaskPaw and/or its licensors own the intellectual
      property rights for all material on TaskPaw. All intellectual property
      rights are reserved. You may access this from TaskPaw for your own personal
    ...
    <ul>
      <li>
        Republish material from TaskPaw
      </li>
      <li>
        Sell, rent or sub-license material from TaskPaw
      </li>
      <li>
        Reproduce, duplicate or copy material from TaskPaw
      </li>
      <li>
        Redistribute content from TaskPaw
      </li>
    </ul>
    <p>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. TaskPaw does not
      filter, edit, publish or review Comments prior to their presence on the
      website. Comments do not reflect the views and opinions of TaskPaw,its
      ...
      applicable laws, TaskPaw shall not be liable for the Comments or for any
    ...
    <p>
      TaskPaw reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant TaskPaw a non-exclusive license to use, reproduce, edit
    ...
    <p>
      ...
      compensates the absence of TaskPaw; and (d) the link is in the context of
    ...
    <p>
      ...
      e-mail to TaskPaw. Please include your name, your organization name,
    ...
    <p>
      No use of TaskPaw's logo or other artwork will be allowed for linking
